...
<head>
    ...
    <title>Web - Selamat Datang di Pesantren Al</title>
                ...
                <div class="col-xs-6 col-sm-8 col-md-9">
                    <div class="header-top_address">
                        <div class="header-top_list">
                            <span class="icon-phone"></span>021 855 2223 6677
                        </div>
                        <div class="header-top_list">
                            <span class="icon-envelope-open"></span>infoponpesAlmuth@gmail.com
                        </div>
                        <div class="header-top_list">
                            <span class="icon-location-pin"></span>Cianjur, Jawa Barat, INA. 19241
                        </div>
                    </div>
            ...
            <div id="carousel" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="carousel-item active">
                        <img class="d-block" src="<?php echo base_url() . 'theme/images/wallup.jpg'?>"
                            alt="First slide">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    ...
                    <p>Kami Menyambut baik terbitnya Website Ponpes Al-Muthmainnah yang baru , dengan harapan
                        dipublikasinya website
                        ini sekolah berharap : Peningkatan layanan pendidikan kepada santri, orangtua, dan masyarakat
                        pada umumnya semakin meningkat. </p>

                </div>
                <div class="col-md-4">
                    <img src="<?php echo base_url() . 'theme/images/halim.jpg'?>" class="img-fluid about-img" alt="#">
                </div>
            </div>
        </div>
    </section>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="event_date">
                                <div class="event-date-wrap">
                                    <p>
                                        <?php echo date("d", strtotime($row->agenda_tanggal)); ?>
                                    </p>
                                    <span>
                                        <?php echo date("M. y", strtotime($row->agenda_tanggal)); ?>
                                    </span>
                                </div>
                            </div>
                            <div class="date-description">
                                ...
                                <p>
                                    <?php echo limit_words($row->agenda_deskripsi, 10) . '...'; ?>
                                </p>
                                <hr class="event_line">
                            </div>
                            <?php
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="foot-logo">
                        ...
                        <p>
                            <?php echo date('Y'); ?> © copyright by <a href="http://Ponpesalmuthmainanh@gmail.com"
                ...
                <div class="col-md-3">
                    <div class="address">
                        <h3>Hubungi Kami</h3>
                        <p><span>Alamat: </span> Cianjur, Jawa Barat, INA. 19232</p>
                        <p>Email : infoponpesAlmuth@gmail.com
                            <br> Phone : +021 8765 6368 986
                        </p>
