                ...
                <div class="col-xs-6 col-sm-8 col-md-9">
                    <div class="header-top_address">
                        <div class="header-top_list">
                            <span class="icon-phone"></span>021 8765 2290 6906
                        </div>
                        <div class="header-top_list">
                            <span class="icon-envelope-open"></span>infoponpesAlmuth@gmail.com
                        </div>
                        <div class="header-top_list">
                            <span class="icon-location-pin"></span>Cianjur, Jawa Barat, INA. 19284
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="blog-tiltle_block">
                        <h4><a href="<?php echo site_url('artikel/' . $slug); ?>">
                                <?php echo $title; ?>
                            </a></h4>
                        <h6> <a href="#"><i class="fa fa-user" aria-hidden="true"></i><span>
                                    <?php echo $author; ?>
                                </span> </a> | <a href="#"><i class="fa fa-tags" aria-hidden="true"></i><span>
                                    <?php echo $kategori; ?>
                                </span></a></h6>
                        <?php echo $blog; ?>
                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-2">
                                                    <div class="blodpost-tab-img"
                                                        ...
                                                        <center>
                                                            <h2 style="padding-top:20%;color:#fff;">
                                                ...
                                                <div class="col-md-10">
                                                    <div class="blogpost-tab-description">
                                                        <h6>
                                                            <?php echo $row->komentar_nama; ?>
                                                        </h6><small><em>
                                                                <?php echo date("d M Y H:i", strtotime($row->komentar_tanggal)); ?>
                                                            </em></small>
                                                        <p>
                                                    ...
                                                    <div class="blogpost-tab-description">
                                                        <h6>
                                                            <?php echo $res->komentar_nama; ?>
                                                                ...
                                                                <?php echo date("d M Y H:i", strtotime($res->komentar_tanggal)); ?>
                                                            </em></small>
                                                        <p>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" name="komentar" rows="6"
                                                        required> </textarea>
                                                </div>
                                                <!-- // end .form-group -->
                                            </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="blog-category_block">
                        ...
                        <ul>
                            ...
                            <li><a href="<?php echo site_url('blog/kategori/' . str_replace(" ", " -",
                                    $row->kategori_nama)); ?>">
                                    <?php echo $row->kategori_nama; ?><i class="fa fa-caret-right"
                                        aria-hidden="true"></i>
                                </a></li>
                            <?php
endforeach; ?>
                    ...
                    <div class="blog-featured_post">
                        ...
                        <div class="blog-featured-img_block">
                            <img width="35%" src="<?php echo base_url() . 'assets/images/' . $row->tulisan_gambar; ?>"
                                class="img-fluid" alt="blog-featured-img">
                            <h5><a href="<?php echo site_url('artikel/' . $row->tulisan_slug); ?>">
                                    <?php echo limit_words($row->tulisan_judul, 3) . '...'; ?>
                                </a></h5>
                            <p>
                                <?php echo limit_words($row->tulisan_isi, 5) . '...'; ?>
                            </p>
                        </div>
                        <hr>
                        <?php
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="foot-logo">
                        ...
                        <p>
                            <?php echo date('Y'); ?> © copyright by <a href="http://infoponpesAlmuth@gmail.com"
                ...
                <div class="col-md-3">
                    <div class="address">
                        <h3>Hubungi Kami</h3>
                        <p><span>Alamat: </span> Cianjur, Jawa Barat, INA. 19218</p>
                        <p>Email : infoponpesAlmuth@gmail.com
                            <br> Phone : +021 8765 6368 9286
                        </p>
