                ...
                <div class="col-xs-6 col-sm-8 col-md-9">
                    <div class="header-top_address">
                        <div class="header-top_list">
                            <span class="icon-phone"></span>021 8765 2216 7966
                        </div>
                        <div class="header-top_list">
                            <span class="icon-envelope-open"></span>infoponpesAlmuth@gmail.com
                        </div>
                        <div class="header-top_list">
                            <span class="icon-location-pin"></span>Cianjur, Jawa Barat, INA. 19298
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="foot-logo">
                        ...
                        <p>
                            <?php echo date('Y'); ?> © copyright by <a href="http://InfoponpeAlmuth.com"
